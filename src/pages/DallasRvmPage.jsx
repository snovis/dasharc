...
import { useDallasCalls, periodToDateRange } from '../hooks/useCallData'
...
export default function DallasRvmPage() {
  ...
  const callsQ = useDallasCalls({ fromDate, toDate })
      ...
      <div className="px-8 py-6 space-y-6">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h1 className="text-xl font-semibold text-slate-900">Dallas RVM Campaign</h1>
            <p className="text-sm text-slate-400 mt-0.5">
              Ringless Voicemail · TX Cold Outreach · Call history
            </p>
          </div>
